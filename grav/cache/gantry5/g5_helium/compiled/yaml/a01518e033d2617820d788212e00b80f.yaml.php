...
return [
    ...
    'filename' => '/Users/jc/Downloads/SIGMobile-Web/grav/user/data/gantry5/themes/g5_helium/particles/content-pro-grav.yaml',
    'modified' => 1524404436,
    'data' => [
        'name' => 'Content PRO (Grav)',
        'description' => 'Display Grav Content in an awesome way.',
        'type' => 'particle',
        'form' => [
            'fields' => [
                'enabled' => [
                    'type' => 'input.checkbox',
                    'label' => 'Enabled',
                    'description' => 'Globally enable Content PRO (Grav) particles.',
                    'default' => true
                ],
                '_note' => [
                    'type' => 'separator.note',
                        ...
                        '_tab_layout' => [
                            ...
                            'fields' => [
                                ...
                                'articledetails' => [
                                    ...
                                    'description' => 'Select if the article details should be shown (Date, Author, Category).',
                                    'default' => 'show',
                                    'options' => [
                                        'show' => 'Show (Top)',
