...
return [
    ...
    'filename' => '/Users/jc/Downloads/SIGMobile-Web/grav/user/data/gantry5/themes/g5_helium/particles/news-pro-grav.yaml',
    'modified' => 1524404436,
    'data' => [
        'name' => 'News PRO (Grav)',
        ...
        'form' => [
            'fields' => [
                'enabled' => [
                    'type' => 'input.checkbox',
                    'label' => 'Enabled',
                    'description' => 'Globally enable News PRO (Grav) particles.',
                    'default' => true
                ],
                '_note' => [
                    'type' => 'separator.note',
